	...
	extends ICE_Feature
{
	...
	public function menu_container()
	{
		...
		<div class="mobile-menu-container">
			<form action="http://dev.mlacommons.org/" method="get" id="adminbarsearch"><input type="text" class="adminbar-input" name="s" id="adminbar-search" value="" maxlength="150"><input type="submit" class="button black" value="Search"></form>
			<?php wp_loginout(); ?>
		</div><?php
	}
