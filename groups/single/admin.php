...
<?php if ( bp_is_group_admin_screen( 'group-settings' ) ) : ?>
	...
	<?php $allowed_sections = apply_filters('bp_group_settings_allowed_sections', array()); ?>

	<?php if(isset($allowed_sections['privacy'])) : ?>
	...
	<?php if(isset($allowed_sections['invitations'])) : ?>
